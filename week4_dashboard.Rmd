...
tags$div(
  ...
  tags$div(
    ...
    # Confidence checkbox (only for XGBoost)
    conditionalPanel(
        ...
        choiceNames = list(
          tags$div(
            ...
            tags$div(
              style = "margin-left: 30px; font-size: 0.9em; color: #555;",
              tags$em(HTML(
                "Confidence bins: red &lt; 0.60, yellow <span style='white-space:nowrap;'>0.60–0.80</span>, green ≥ 0.80."
              ))
            )
          )
        ),
    ...
    # Viewpoint dropdown only if viewshed is enabled
    conditionalPanel(
